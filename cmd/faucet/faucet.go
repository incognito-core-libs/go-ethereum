...
import (
	...
	"github.com/incognito-core-libs/go-ethereum/ethclient"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/incognito-core-libs/go-ethereum/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
